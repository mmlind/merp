...
-->
    ...
    <div class="container-fluid">
      ...
      <form method="post" class="needs-validation" novalidate onchange="validate_page();">
        ...
        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Order Contact')</label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Order Email')</label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Order Phone')</label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Finance Contact')</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="finance_contact" name="finance_contact" />
          </div>
        </div>

        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Finance Email')</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="finance_email" name="finance_email" />
          </div>
        </div>

        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Finance Phone')</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="finance_phone" name="finance_phone" />
          </div>
        </div>


        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Bank Name')</label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Bank Account')</label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          <label for="colFormLabel" class="col-sm-3 col-form-label">_('Info')</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="info" name="info" />
            <!--
            <textarea class="form-control rounded-0" id="info" name="info" rows="5"></textarea>
          -->
          </div>
        </div>
